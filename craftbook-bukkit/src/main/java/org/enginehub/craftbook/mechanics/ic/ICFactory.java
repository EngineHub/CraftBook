...
public interface ICFactory {
    ...
    /**
     * Create an IC instance given a block. The verify method should already have been called before
     * this function,
     ...
     * permissions, since that is only done when placing blocks for a new IC, and this can be
     * invoked many times in
     * the life of an IC.
     *
     * @param sign
