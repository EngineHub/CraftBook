...
public class HeadDropsCommands {
    ...
    public void giveItem(Actor actor,
        ...
        EntityType bukkitEntityType = BukkitAdapter.adapt(entityType);
        ItemStack toDrop = headDrops.createFromEntityType(bukkitEntityType);
        if (toDrop != null) {
        ...
        if (toDrop == null || !player.getInventory().addItem(toDrop).isEmpty()) {
            actor.printError(TranslatableComponent.of(
                ...
                TextComponent.of(bukkitEntityType.translationKey(), TextColor.WHITE)
            ));
            return;
        }
        ...
        if (!silent) {
            actor.printInfo(TranslatableComponent.of(
                ...
                TranslatableComponent.of(bukkitEntityType.translationKey(), TextColor.WHITE),
                TextComponent.of(player.getName(), TextColor.WHITE)
            ));
        }
    }
