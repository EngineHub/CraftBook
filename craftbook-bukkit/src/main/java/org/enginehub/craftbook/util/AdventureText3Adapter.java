...
public class AdventureText3Adapter {

    public static net.kyori.adventure.text.Component toAdventure(com.sk89q.worldedit.util.formatting.text.Component component) {
    ...
    public static com.sk89q.worldedit.util.formatting.text.Component fromAdventure(net.kyori.adventure.text.Component component) {
