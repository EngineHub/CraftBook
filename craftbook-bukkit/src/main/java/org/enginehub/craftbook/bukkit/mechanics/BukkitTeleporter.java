 ...
 */
public class BukkitTeleporter extends Teleporter implements Listener {
    ...
    public void onCommonClick(PlayerInteractEvent event) {
        ...
        if (maxRange > 0) {
            if (localPlayer.getLocation().toVector().distanceSq(BukkitAdapter.adapt(destination.getLocation()).toVector()) > maxRange * maxRange) {
