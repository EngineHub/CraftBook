...
public class BukkitMinecartNoCollide extends MinecartNoCollide implements Listener {

    public BukkitMinecartNoCollide(MechanicType<? extends CraftBookMechanic> mechanicType) {
        super(mechanicType);
    }
