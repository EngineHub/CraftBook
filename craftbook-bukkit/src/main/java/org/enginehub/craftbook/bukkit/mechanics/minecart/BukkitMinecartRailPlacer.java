...
public class BukkitMinecartRailPlacer extends MinecartRailPlacer implements Listener {

    public BukkitMinecartRailPlacer(MechanicType<? extends CraftBookMechanic> mechanicType) {
        super(mechanicType);
    }
