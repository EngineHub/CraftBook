...
import com.sk89q.craftbook.mechanics.RedstoneFire;
...
public class MechanicTypes {
    ...
    @Nullable public static final MechanicType<LightStone> LIGHTSTONE = get("lightstone");
    ...
    @Nullable public static final MechanicType<RedstoneFire> REDSTONE_FIRE = get("redstone_fire");
