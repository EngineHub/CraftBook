...
public class SpongeConfiguration implements DocumentationProvider {
    ...
    public ConfigValue<List<String>>
            enabledMechanics = new ConfigValue<>("enabled-mechanics", "The list of mechanics to load.", Collections.singletonList("Variables"), null);
