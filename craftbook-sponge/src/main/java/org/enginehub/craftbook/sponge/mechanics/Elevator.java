...
public class Elevator extends SpongeSignMechanic implements DocumentationProvider {
    ...
    private ConfigValue<Boolean>
            allowJumpLifts = new ConfigValue<>("allow-jump-lifts", "Allow lifts that the user can control by jumping, or sneaking.", true);
    ...
    private SpongePermissionNode
            createPermissions = new SpongePermissionNode("craftbook.elevator", "Allows the user to create Elevators", PermissionDescription.ROLE_USER);
