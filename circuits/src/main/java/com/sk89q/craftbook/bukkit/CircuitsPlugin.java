...
public class CircuitsPlugin extends BaseBukkitPlugin {
    ...
    public void onEnable() {
        ...
        if (config.enableNetherstone) manager.register(new Netherrack.Factory());
        if (config.enablePumpkins) manager.register(new JackOLantern.Factory());
        if (config.enableGlowStone) manager.register(new GlowStone.Factory());
        if (config.enableICs) {
    ...
    private void registerICs() {
        ...
        //SISOs
        icManager.register("MC1000", new Repeater.Factory(server), familySISO, familyAISO);
        icManager.register("MC1001", new Inverter.Factory(server), familySISO, familyAISO);
        icManager.register("MC1017", new ToggleFlipFlop.Factory(server, true), familySISO, familyAISO);
        icManager.register("MC1018", new ToggleFlipFlop.Factory(server, false), familySISO, familyAISO);
        icManager.register("MC1020", new RandomBit.Factory(server), familySISO, familyAISO);
        ...
        icManager.register("MC1236", new WeatherFaker.Factory(server), familySISO, familyAISO);        // Restricted
        icManager.register("MC1237", new TimeFaker.Factory(server), familySISO, familyAISO);           // Restricted
        icManager.register("MC1240", new ArrowShooter.Factory(server), familySISO, familyAISO);        // Restricted
        icManager.register("MC1241", new ArrowBarrage.Factory(server), familySISO, familyAISO);        // Restricted
        icManager.register("MC1250", new FireShooter.Factory(server), familySISO, familyAISO);         // Restricted
        icManager.register("MC1251", new FireBarrage.Factory(server), familySISO, familyAISO);         // Restricted
        icManager.register("MC1260", new WaterSensor.Factory(server), familySISO, familyAISO);
        ...
        icManager.register("MC2101", new NotDelayer.Factory(server), familySISO, familyAISO);
        icManager.register("MC2110", new LowDelayer.Factory(server), familySISO, familyAISO);
        icManager.register("MC2111", new NotLowDelayer.Factory(server), familySISO, familyAISO);
        icManager.register("MC2500", new Pulser.Factory(server), familySISO, familyAISO);
        icManager.register("MC2501", new NotPulser.Factory(server), familySISO, familyAISO);
        icManager.register("MC2510", new LowPulser.Factory(server), familySISO, familyAISO);
        icManager.register("MC2511", new LowNotPulser.Factory(server), familySISO, familyAISO);
