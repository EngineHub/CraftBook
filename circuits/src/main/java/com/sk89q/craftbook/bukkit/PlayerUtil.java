...
public class PlayerUtil {
    ...
    public static Player checkPlayer (CommandSender sender) throws CommandException {
        ...
        else throw new CommandException("A player context is required. (Specify a world or player if the command " + "supports it.)");
    }
    ...
    public static Player matchPlayerExactly (CommandSender sender, String filter) throws CommandException {
        ...
        Player[] players = CircuitsPlugin.server.getOnlinePlayers();
        for (Player player : players)
            if (player.getName().equalsIgnoreCase(filter) || player.getDisplayName().equalsIgnoreCase(filter)) return player;
    ...
    public static Player matchSinglePlayer (CommandSender sender, String filter) throws CommandException {
        ...
        if (players.hasNext()) throw new CommandException("More than one player found! " + "Use @<name> for exact matching.");
