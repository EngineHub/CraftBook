 ...
 */
public abstract class Ammeter extends AbstractCraftBookMechanic {

    public Ammeter(MechanicType<? extends CraftBookMechanic> mechanicType) {
        super(mechanicType);
    }

    protected static Component getCurrentLine(int data) {
    ...
    public void loadFromConfiguration(YAMLProcessor config) {
        ...
        item = ItemParser.getItem(config.getString("item", ItemTypes.COAL.id())).getType();
