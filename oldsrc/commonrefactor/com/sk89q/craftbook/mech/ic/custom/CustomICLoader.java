...
public class CustomICLoader {
    ...
    public static void load(String source, CustomICAccepter dest, HashMap<String,
            PlcLang> languages) throws CustomICException {
                    ...
                    case 2:
                        switch (y.symbol) {
                            ...
                            case SYM_FILE:
                                ...
                                break;
                            default:
                                throw new CustomICException("unexpected token: " + y.value + " (" + y.line + ":" + y
                                        .col + ")");
                        }
                        break;
                    default:
                        throw new CustomICException("internal error: unknown state");
                }
            }
