...
public class Colors {
    //Source: http://mc.kev009.com/wiki/Chat
    ...
    public static final String DARK_CYAN    = COLOR_CODE+"3";
    public static final String DARK_RED     = COLOR_CODE+"4";
    public static final String PURPLE       = COLOR_CODE+"5";
    ...
    public static final String BRIGHT_GREEN = COLOR_CODE+"a";
    public static final String CYAN         = COLOR_CODE+"b";
    public static final String RED          = COLOR_CODE+"c";
    public static final String PINK         = COLOR_CODE+"d";
