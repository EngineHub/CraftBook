...
public class CopyManager {
    ...
    /**
     * Load a copy from disk. This may return a cached copy. If the copy is not cached, the file will be loaded from disk if possible. If the copy
     * does not exist, an exception will be raised. An exception may be raised if the file exists but cannot be read for whatever reason.
     * 
     * @param namespace
     * @param id
     * @return
