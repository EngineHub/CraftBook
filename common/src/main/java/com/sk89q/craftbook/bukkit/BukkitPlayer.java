    ...
    public void print (String message) {
        ...
        try {
            ...
            if (plugin.getLanguageManager() == null || plugin.getLanguageManager().getPlayersLanguage(player) == null
                    || plugin.getLanguageManager().getString(message, plugin.getLanguageManager().getPlayersLanguage(player)) == null)
                player.sendMessage(ChatColor.GOLD + message);
            player.sendMessage(ChatColor.GOLD
                    + plugin.getLanguageManager().getString(message, plugin.getLanguageManager().getPlayersLanguage(player)));
        } catch (Exception e) {
        }
    }
