...
public abstract class SimpleArea extends SpongeMechanic {
    ...
    public void onPlayerInteract(HumanInteractBlockEvent event) {
        ...
        if(SignUtil.isSign(event.getBlock())) {
            ...
            if(triggerMechanic(event.getBlock(), sign, event.getHuman()) && event instanceof Cancellable)
     ...
     */
    public abstract boolean triggerMechanic(BlockLoc block, Sign sign, @Nullable Human human);
}
