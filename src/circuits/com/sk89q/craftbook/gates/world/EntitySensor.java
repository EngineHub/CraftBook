...
public class EntitySensor extends AbstractIC {
    ...
    protected static int maxArea, maxDistance;
    ...
    public void setConfig(int radius, int distance) {
		maxArea = radius;
    ...
    static boolean doMatch(Sign sign, boolean verify_only) throws ICVerificationException {
