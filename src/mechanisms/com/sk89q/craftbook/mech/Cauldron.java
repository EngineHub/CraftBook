...
public class Cauldron extends Mechanic{
    ...
    private void performCauldron(Player player, World world, BlockWorldVector pt) {
        ...
        try {
            ...
            if (recipe != null) {
                ...
                player.sendMessage(ChatColor.GOLD + "In a poof of smoke, you've made "
                        + recipe.getName() + ".");
                ...
                for (Integer id : recipe.getResults()) {
                	world.dropItem(player.getLocation(), new ItemStack(id,1));
                }
     ...
     */
    public void findCauldronContents(World world, BlockWorldVector pt, int minY, int maxY,
